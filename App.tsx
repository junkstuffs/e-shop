  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-lush-cream">
      ...
      <div className="absolute bottom-12 right-8 md:right-12 flex flex-col items-center gap-2 animate-pulse opacity-50">
        <div className="text-[10px] uppercase tracking-widest text-lush-dark writing-vertical-rl rotate-180">Scroll</div>
      ...
      <div className="container mx-auto px-6 md:px-12 space-y-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          <div className="lg:col-span-1 border-r border-lush-dark/10 p-4 flex flex-col justify-between hidden lg:flex">
             <div className="text-xs font-bold tracking-widest text-lush-dark/40 uppercase writing-vertical-lr rotate-180 h-32">
               Equity Partners
             </div>
  ...
  return (
    <section className="relative bg-lush-dark text-lush-cream overflow-hidden">
      ...
      <div className="w-full h-[60vh] relative">
        ...
        <div className="absolute bottom-0 w-full flex justify-around items-end px-12 opacity-80 mix-blend-overlay pointer-events-none">
           {[...Array(5)].map((_, i) => (
             <div key={i} className={`w-16 md:w-32 bg-black/60 rounded-t-lg backdrop-blur-sm transform translate-y-4`} style={{ height: `${10 + Math.random() * 15}rem` }}></div>
           ))}
        </div>
      </div>
    </section>
